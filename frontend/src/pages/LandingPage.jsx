  ...
  const features = [
    {
      ...
      description:
        "Advanced CNN model for accurate soil classification and prediction",
    },
    {
      icon: Scale,
      title: "Precision Weight Measurement",
      description:
        "Loadcell sensor integration via ESP32 for accurate soil sample weight measurement",
    },
    {
      icon: BarChart3,
      title: "Real-time Data Processing",
      description:
        "Instant analysis results with comprehensive soil composition breakdown",
    },
    {
      icon: Users,
      title: "Multi-Role System",
      description:
        "Separate portals for Engineers, Experts, and Administrators",
    },
    {
      icon: Cpu,
      title: "IoT Integration",
      description:
        "Seamless ESP32 connectivity for automated weight data collection",
    },
    {
      icon: Shield,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 text-slate-900 dark:text-slate-100 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            <p className="text-lg text-slate-500 dark:text-slate-500 mb-12 max-w-2xl mx-auto">
              Advanced AI-powered platform with IoT integration for accurate
              soil classification, weight measurement, and comprehensive
              analysis
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl p-8 rounded-2xl shadow-lg border border-slate-200/50 dark:border-slate-700/50">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-4">
                High-precision loadcell sensors provide accurate weight
                measurements for soil samples. The system measures total weight,
                gravel weight, and sand weight with exceptional accuracy.
              </p>
            ...
            <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl p-8 rounded-2xl shadow-lg border border-slate-200/50 dark:border-slate-700/50">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-4">
                ESP32 microcontroller acts as the bridge between the loadcell
                sensor and the web application. It processes weight data and
                communicates wirelessly with the backend system.
              </p>
              <ul className="list-disc list-inside text-slate-600 dark:text-slate-400 space-y-2">
            ...
            {[
              {
                ...
                title: "Capture Image",
                description:
                  "Capture soil sample images using your device camera for AI-powered classification",
              },
              {
                step: "2",
                title: "AI Analysis",
                description:
                  "Our advanced CNN model analyzes the soil composition and classifies the type",
              },
              {
                step: "3",
                title: "Measure Weight",
                description:
                  "Place soil samples on loadcell sensor connected to ESP32 for precise weight measurement",
              },
              {
                step: "4",
                title: "Get Results",
                description:
                  "Receive detailed analysis reports with composition percentages and USCS classification",
              },
            ].map((item, index) => (
              <div
                key={index}
      ...
      <footer className="py-8 border-t border-slate-200 dark:border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-slate-600 dark:text-slate-400">
            © {new Date().getFullYear()} GeoTech Soil Analysis. All rights
            reserved.
          </p>
        </div>
      </footer>
